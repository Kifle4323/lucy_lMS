...
export function registerAssessmentRoutes(router) {
    router.post('/courses/:courseId/assessments', authRequired, requireRole(['TEACHER']), async (req, res) => {
    ...
    router.post('/assessments/:assessmentId/questions', authRequired, requireRole(['TEACHER']), async (req, res) => {
        ...
        const assessment = await prisma.assessment.findUnique({ where: { id: params.assessmentId }, include: { course: { include: { courseClasses: true } } } });
        if (!assessment) {
    ...
    router.get('/courses/:courseId/assessments', authRequired, async (req, res) => {
        const params = z.object({ courseId: z.string() }).parse(req.params);
    ...
    router.patch('/assessments/:assessmentId/open', authRequired, requireRole(['TEACHER']), async (req, res) => {
        const params = z.object({ assessmentId: z.string() }).parse(req.params);
    ...
    router.get('/assessments/:assessmentId/manual-grades', authRequired, requireRole(['TEACHER']), async (req, res) => {
        const params = z.object({ assessmentId: z.string() }).parse(req.params);
        const assessment = await prisma.assessment.findUnique({
            where: { id: params.assessmentId },
            include: { course: { include: { courseClasses: true } } },
    ...
    router.put('/assessments/:assessmentId/manual-grades/:studentId', authRequired, requireRole(['TEACHER']), async (req, res) => {
    ...
    router.delete('/assessments/:assessmentId/manual-grades/:studentId', authRequired, requireRole(['TEACHER']), async (req, res) => {
        const params = z.object({ assessmentId: z.string(), studentId: z.string() }).parse(req.params);
        const assessment = await prisma.assessment.findUnique({
            where: { id: params.assessmentId },
            include: { course: { include: { courseClasses: true } } },
    ...
    router.post('/assessments/:assessmentId/attempts', authRequired, requireRole(['STUDENT']), async (req, res) => {
        const params = z.object({ assessmentId: z.string() }).parse(req.params);
        const assessment = await prisma.assessment.findUnique({
            where: { id: params.assessmentId },
            include: {
    ...
    router.get('/attempts/:attemptId', authRequired, async (req, res) => {
    ...
    router.patch('/attempts/:attemptId/answers', authRequired, requireRole(['STUDENT']), async (req, res) => {
        const params = z.object({ attemptId: z.string() }).parse(req.params);
        const body = z.object({
            questionId: z.string(),
    ...
    router.post('/attempts/:attemptId/submit', authRequired, requireRole(['STUDENT']), async (req, res) => {
        const params = z.object({ attemptId: z.string() }).parse(req.params);
        const attempt = await prisma.attempt.findUnique({
            where: { id: params.attemptId },
    ...
    router.post('/attempts/:attemptId/grade', authRequired, requireRole(['TEACHER']), async (req, res) => {
        const params = z.object({ attemptId: z.string() }).parse(req.params);
        const body = z.object({
